...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (login($username, $password)) {
        ...
        $_SESSION['welcome_username'] = $username;
        $_SESSION['user_role'] = getUserRole();
        
        // Redirect to welcome page
        redirect('welcome.php');
    } else {
        // Check if it's a maintenance mode rejection
        if ($maintenanceMode) {
            $error = "System is currently in maintenance mode. Only administrators can login at this time.";
        } else {
...
<head>
    ...
    <title>Secure Login - CDF Management System | Government of Zambia</title>
    <meta name="description" content="Official secure login portal for CDF Management System - Government of the Republic of Zambia">
    <meta name="keywords" content="Zambia Government, CDF, Login, Secure Access, Constituency Development Fund">
        ...
        <div class="login-card">
            ...
            <div class="login-form">
                ...
                <div class="government-notice">
                    ...
                    <p class="mb-0 small text-muted">This is a secure government system. Authorized personnel only. All activities are logged and monitored.</p>
                </div>
                ...
                <div class="form-section">
                    ...
                    <form method="POST">
                        ...
                        <div class="mb-4 text-end">
                            <a href="forgot_password.php" class="btn btn-link text-decoration-none p-0">
                ...
                <div class="mt-4 p-4 bg-light rounded">
                    ...
                    <p class="mb-0 small">If you're having trouble accessing your account, please contact the CDF support team at <a href="mailto:support@cdf.gov.zm" class="text-primary fw-semibold">support@cdf.gov.zm</a> or call +260-211-123456.</p>
                </div>
            </div>
        </div>
    </div>
